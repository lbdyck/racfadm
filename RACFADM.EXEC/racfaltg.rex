/*%NOCOMMENT====================* REXX *==============================*/
/*PURPOSE:  RACFADM - Alter selected Group Profile segments           */
/*--------------------------------------------------------------------*/
/* FLG  YYMMDD  USERID   DESCRIPTION                                  */
/* ---  ------  -------  -------------------------------------------- */
/* @A0  250314  TRIDJK   Creation                                     */
/*====================================================================*/
PANELAL     = 'RACFGRP9'           /* Alter prompt popup panel */
...
if pos('NOT DEFINED TO RACF',search.1) > 1 then do
  ...
  racflmsg = 'Group 'group' not defined to RACF'
  'setmsg msg(RACF011)'
  iterate
  end
...
do i=1 to RACF.0 /* get the segment names */
  ...
  if wordpos(segment,gsegs) = 0 then
    iterate
